...
Report suspected vulnerabilities privately to `security@perkcommons.org`. Do not
open a public issue for an exploitable vulnerability or include real personal
data in a report. Include affected component, reproduction steps, impact, and a
